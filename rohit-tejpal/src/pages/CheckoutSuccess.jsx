  ...
  return (
    <div className="pt-32 pb-24 bg-[#f8f9fa] min-h-[80vh] flex items-center justify-center">
      <div className="bg-white p-8 md:p-12 rounded-xl shadow-sm border border-gray-100 max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-[var(--color-primary-dark)] mb-2 uppercase tracking-wide">Payment Successful</h1>
        <p className="text-gray-500 mb-8">Thank you for your order! We'll start processing it right away.</p>
          ...
          {order && (
            <>
              ...
              <div className="flex justify-between items-center">
                <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Payment ID</span>

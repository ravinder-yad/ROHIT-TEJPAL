      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 translate-y-full opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 hidden lg:flex z-20 gap-[1px]">
          <AnimatedButton 
            ...
            fullWidth={true}
            icon={false}
            className="flex-1 bg-black/50 backdrop-blur-md !border-none text-[10px] sm:text-xs"
          >
          ...
          <AnimatedButton 
            ...
            fullWidth={true}
            icon={false}
            className="flex-1 bg-[#25D366]/90 backdrop-blur-md !border-none text-white text-[10px] sm:text-xs hover:bg-[#25D366]"
          >

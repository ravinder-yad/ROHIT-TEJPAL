...
const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--color-main-bg)] text-[var(--color-text-main)] font-sans border-t border-[var(--color-border)]/50 mt-auto w-full">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          {/* Brand Info */}
          <div className="lg:col-span-2 flex flex-col items-start border-b border-[var(--color-border)]/50 pb-12 md:pb-0 md:border-b-0 pr-4">
            <Link to="/" className="inline-block mb-6 md:mb-10 ml-0 md:ml-4">
              <BrandLogoImage className="h-[60px] md:h-[95px] w-auto object-contain transform md:scale-[1.3] origin-left" />
            </Link>
            ...
            <p className="text-[var(--color-text-secondary)] font-light text-xs md:text-sm leading-relaxed max-w-sm italic">
            ...
            {/* WhatsApp CTA */}
            <div className="mt-10">
              <p className="text-[var(--color-text-secondary)] text-xs mb-3 italic">Need help?</p>
              <a 
                href="https://wa.me/919873737512" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[var(--color-gold)] hover:text-[var(--color-text-main)] transition-colors group text-sm border-b border-[var(--color-gold)]/30 hover:border-[var(--color-text-main)] pb-1"
              >
          ...
          {/* Links - Shop */}
          <div className="border-b border-[var(--color-border)]/50 pb-8 md:pb-0 md:border-b-0">
            <h3 className="text-[12px] md:text-[13px] font-semibold uppercase tracking-[0.12em] mb-6 text-[var(--color-gold)]">Shop</h3>
            <ul className="space-y-4 text-[13px] md:text-sm text-[var(--color-text-secondary)] font-light">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-8 border-t border-[var(--color-border)]/50 gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 w-full md:w-auto">
            ...
            <div className="flex items-center gap-8 md:gap-6 mt-2 md:mt-0">
              <a href="https://www.instagram.com/rohit.tejpal_official?igsh=Y2p0YW9nY3lrNWR6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[var(--color-text-secondary)] hover:text-[var(--color-gold)] transition-colors text-xs md:text-sm">
                <FaInstagram className="w-5 h-5 md:w-6 md:h-6" /> <span className="md:hidden lg:inline">Instagram</span>
              </a>
              <a href="https://wa.me/919873737512" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[var(--color-text-secondary)] hover:text-[var(--color-gold)] transition-colors text-xs md:text-sm">
        ...
        {/* Bottom Legal Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[var(--color-border)]/50 gap-6 md:gap-4 text-[11px] md:text-xs text-[var(--color-text-secondary)] font-light text-center md:text-left">

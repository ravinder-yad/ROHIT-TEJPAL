...
const Craftsmanship = () => {
  return (
    <section className="py-24 md:py-32 bg-[var(--color-primary-dark)] overflow-hidden">
      <div className="container-max px-4 md:px-8 lg:px-16">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute top-8 md:top-12 -left-4 md:-left-8 w-full h-full bg-white/5 -z-10"></div>
            
            <div className="relative aspect-[3/4] max-w-[500px] mx-auto overflow-hidden shadow-2xl bg-white/5">
              <img 
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-8 -right-2 md:right-12 bg-[var(--color-primary-dark)]/90 backdrop-blur-md p-6 shadow-2xl max-w-[200px] hidden md:block z-20 border border-white/10">
              <p className="text-white text-[10px] font-bold tracking-[0.25em] leading-relaxed uppercase">
                Premium Quality <br/>
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mt-8 lg:mt-0">
            ...
            <h2 className="text-white text-4xl md:text-5xl lg:text-[4rem] leading-tight font-serif font-light mb-10 tracking-wide">
              CRAFTED WITH <br className="hidden md:block"/>
              <span className="italic text-[var(--color-gold)] font-medium">PURPOSE</span>
            </h2>
            
            <p className="text-gray-300 text-sm md:text-base lg:text-lg leading-[2] font-light mb-12 max-w-[500px]">
